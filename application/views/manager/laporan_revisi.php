...
<script>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" id="print_area">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <center><h5>Pengajuan Koreksi Absen Periode ${bulan[res.bulan-1]} ${res.tahun}</h5></center><br>
                                    </div>
                                </div><br><br>
    ...
    const laporanRevisiController = ((UI) => {
        ...
        const submitFilter = () => {
            $(DOM.form).validate({
                ...
                submitHandler: function(form){
                    ...
                    $.ajax({
                        url: `<?= base_url('api/revisi_absen/laporan/') ?>${auth.token}?bulan=${bulan}&tahun=${tahun}`,
                        type: 'GET',
                        dataType: 'JSON',
                        beforeSend: function(){
